...
austen_gen = pd.read_csv("gen_samples/austen_sample_pos.csv")
twain_gen = pd.read_csv("gen_samples/twain_sample_pos.csv")
dickens_gen = pd.read_csv("gen_samples/dickens_sample_pos.csv")
