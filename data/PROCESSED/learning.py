...
austen_gen_pos = pd.read_csv("gen_samples/austen_50/austen_sample_pos.csv")
twain_gen_pos = pd.read_csv("gen_samples/twain_50/twain_sample_pos.csv")
dickens_gen_pos = pd.read_csv("gen_samples/dickens_50/dickens_sample_pos.csv")
...
austen_gen_func = pd.read_csv("gen_samples/austen_50/austen_sample_func.csv")
twain_gen_func = pd.read_csv("gen_samples/twain_50/twain_sample_func.csv")
dickens_gen_func = pd.read_csv("gen_samples/dickens_50/dickens_sample_func.csv")
